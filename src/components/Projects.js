...
export default function Projects() {
    return (
        <div className="projects-wrapper">
            ...
            <div className="projects-area">
                <p className="skill-title">Sketch to UI</p>
                <p className="skill-desc">A rapid prototyping tool for converting hand drawn sketches on paper to a working html code using a trained end-to-end deep learning model integrated pipeline.</p>
